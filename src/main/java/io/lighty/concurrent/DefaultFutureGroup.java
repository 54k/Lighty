...
public final class DefaultFutureGroup<V> extends io.lighty.concurrent.AbstractFutureGroup<V, FutureGroup<V>> implements FutureGroup<V> {
    ...
    protected void notify0() {
        ...
        if (failureCount() > 0) {
            ...
            setFailure0(new io.lighty.concurrent.FutureGroupException(failed));
        } else {
            setSuccess0();
        }
    }
